...
<body style="background: rgb(241, 240, 240)">
    ...
    <center>
        <div
            ...
            <h3>ADA SEDIKIT KENDALA DISINI</h3>
            <h3>Silakan klik tombol dibawah ini untuk kembali ke beranda</h3>
            <br>
            <br>
            <a href="{{ route('welcome') }}" style="background: rgb(0, 0, 121);padding:10px;margin-top: 40px;color:white;border-radius:30px;text-decoration:none">
                KEMBALI KE BERANDA
            </a>
        </div>
    </center>
